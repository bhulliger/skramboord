...
<table>
	<tr>
		...
		<th style="text-align:center;width: 50px;"><g:message code="release.releases"/></th>
	...
	<tr>
		...
		<td style="vertical-align: middle;text-align:center;">${flash.project?.releases?.size()}</td>
		<td style="vertical-align: middle;text-align:center;">${flash.project.countSprints()}</td>
		<g:if test="${org.codehaus.groovy.grails.plugins.springsecurity.SpringSecurityUtils.ifAnyGranted('ROLE_SUPERUSER') || session.user.equals(flash.project.owner)}">
			<td>
